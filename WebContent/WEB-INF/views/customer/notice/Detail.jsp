			...
			<div id="content">
				...
				<div id="notice-article-detail" class="article-detail margin-large">
					...
					<dl class="article-detail-row">
						...
						<dd class="article-detail-data">${n.regDate}</dd>
					</dl>
					<dl class="article-detail-row half-row">
						<dt class="article-detail-title">작성자</dt>
						<dd class="article-detail-data half-data">${n.writerId}</dd>
					</dl>
					<dl class="article-detail-row half-row">
				...
				<p class="article-comment margin-small">
					<a class="btn-list button" href="list">목록</a> <a
						class="btn-edit button" href="update?id=${n.id}">수정</a> <a
						class="btn-del button" href="delete?id=${n.id}">삭제</a>
				</p>
				<div class="margin-small" style="border-top: 1px solid #dfdfdf;">
					<dl class="article-detail-row">
						<dt class="article-detail-title">▲ 다음글</dt>
						<dd class="article-detail-data">${nexttitle}</dd>
					</dl>
					<dl class="article-detail-row">
						<dt class="article-detail-title">▼ 이전글</dt>
						<dd class="article-detail-data">${backtitle}</dd>
					</dl>
				</div>
			</div>
			<!-- aside -->
